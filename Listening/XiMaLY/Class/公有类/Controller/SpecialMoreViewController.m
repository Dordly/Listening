...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ctrlVC.specialId = [self.specialVM albumIDForSection:indexPath.section index:indexPath.row];
    ctrlVC.specialTitle = [self.specialVM titleForSection:indexPath.section row:indexPath.row];

...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *title = [self.rankVM titleForSection:indexPath.section row:indexPath.row];
    NSString *key = [self.rankVM keyForSection:indexPath.section row:indexPath.row];
    NSString *type = [self.rankVM contentTypeForSection:indexPath.section row:indexPath.row];
    
    RankListViewController *ctrlVC = [[RankListViewController alloc] initWithTitle:title type:type rankingListKey:key];
